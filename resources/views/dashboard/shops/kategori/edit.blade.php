    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans('kategori.title.edit') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">{{Breadcrumbs::render('kategori_edit',$kategori)}}</li>
                    </ol>
                </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_category_title" value="{{ old('title', $kategori->title) }}" name="title" type="text" class="form-control @error('title') is-invalid @enderror" placeholder="{{ trans('kategori.form_control.input.title.placeholder') }}" />
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_category_slug" value="{{ old('slug', $kategori->slug) }}" name="slug" type="text" class="form-control @error('slug') is-invalid @enderror" placeholder="{{ trans('categories.form_control.input.slug.placeholder') }}" readonly />
                                @error('slug')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="input_category_thumbnail" name="thumbnail" value="{{ old('thumbnail', asset($kategori->thumbnail)) }}" type="text" class="form-control @error('thumbnail') is-invalid @enderror" placeholder="{{ trans('kategori.form_control.input.thumbnail.placeholder') }}" readonly />
                                    @error('thumbnail')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="input_kategori_description" name="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="{{ trans('kategori.form_control.textarea.description.placeholder') }}">{{ old('description', $kategori->description) }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="float-right">
                                ...
                                <button type="submit" class="btn btn-primary px-4">{{ trans('kategori.button.edit.value') }}</button>
                            </div>                
                            </form>
                        </div>
                    </div>
