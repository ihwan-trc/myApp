<nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('gheptech.home') }}" class="nav-link">Home</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" id="language" href="#">
            ...
            <div class="dropdown-menu dropdown-menu-right p-0">
                <a href="{{ route('localization.switch', ['language' => 'id']) }}" class="dropdown-item">
                    <i class="flag-icon flag-icon-id mr-2"></i> {{ trans('localization.id') }}
                </a>
                <a href="{{ route('localization.switch', ['language' => 'en']) }}" class="dropdown-item">
                    <i class="flag-icon flag-icon-us mr-2"></i> {{ trans('localization.en') }}
                </a>
            </div>
        </li>
        <li class="nav-item dropdown">
