                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="{{ route('blog.posts.category',['slug' => $item->slug]) }}">
                                        {{ $item->title }} 
                                    </a><span class="badge bg-primary rounded-pill">2</span>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="card mb-3">
                            @if (file_exists(public_path($produk->thumbnail)))
                                <img class="card-img-top" src="{{ asset($produk->thumbnail) }}" alt="{{ $produk->title }}">
                            @else
                                <img class="img-fluid rounded" src="https://source.unsplash.com/1200x400/?website" class="card-img-top" alt="{{ $produk->title }}">
                            @endif
                            <div class="card-body">
                                <h5 class="card-title text-center fw-bold mb-5">{{ $produk->title }}</h5>
                                <p class="card-text">{{ $produk->description }}</p>
                                <p class="card-text">{!! $produk->content !!}</p>
